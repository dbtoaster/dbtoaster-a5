...
functional compiler internal IRs (i.e. after
defunctionalization~\cite{danvy-ppdp:01}).
...
The imperative IR also supports external functions and types to enable the usage
...
due to space constraints. Overall, our imperative optimizer is a
