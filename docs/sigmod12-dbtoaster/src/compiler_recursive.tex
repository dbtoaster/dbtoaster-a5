...
By the above theorem, this recursive query transformation terminates in the $\deg(Q)$-recursion level,
...
\noindent
for each $j \in 1 \dots \deg(Q)$ and $\tuple{i_1 \dots i_j} \in {1 \dots k}^j$. Note that for correctness, unless we maintain
