...
(\Delta_{} A \times \rho_{2}(A) \times \rho_{11}(A) \times \rho_{22}(A))\cup
( A \times \Delta_{}\rho_{2}(A) \times \rho_{11}(A) \times \rho_{22}(A))\cup
\\&&\quad
( A \times \rho_{2}(A) \times \Delta_{} \rho_{11}(A) \times \rho_{22}(A))\cup
( A \times \rho_{2}(A) \times \rho_{11}(A) \times \Delta_{}\rho_{22}(A))\cup
\\&&\quad
(\Delta_{} A \times \Delta_{}\rho_{2}(A) \times \rho_{11}(A) \times \rho_{22}(A))\cup
( \Delta_{}A \times \rho_{2}(A) \times \Delta_{}\rho_{11}(A) \times \rho_{22}(A))\cup
\\&&\quad
(\Delta_{} A \times \rho_{2}(A) \times \rho_{11}(A) \times \Delta_{}\rho_{22}(A))\cup
( A \times \Delta_{}\rho_{2}(A) \times \Delta_{}\rho_{11}(A) \times \rho_{22}(A))\cup
\\&&\quad
( A \times \Delta_{}\rho_{2}(A) \times \rho_{11}(A) \times \Delta_{}\rho_{22}(A))\cup
( A \times \rho_{2}(A) \times \Delta_{}\rho_{11}(A) \times \Delta_{}\rho_{22}(A))\cup
\\&&\quad
( \Delta_{}A \times \Delta_{}\rho_{2}(A) \times \Delta_{}\rho_{11}(A) \times \rho_{22}(A))\cup
( \Delta_{}A \times \Delta_{}\rho_{2}(A) \times \rho_{11}(A) \times \Delta_{}\rho_{22}(A))\cup
\\&&\quad
( \Delta_{}A \times \rho_{2}(A) \times \Delta_{}\rho_{11}(A) \times \Delta_{}\rho_{22}(A))\cup
( A \times \Delta_{}\rho_{2}(A) \times \Delta_{}\rho_{11}(A) \times \Delta_{}\rho_{22}(A))\cup
\\&&\quad
( \Delta_{}A \times \Delta_{}\rho_{2}(A) \times \Delta_{}\rho_{11}(A) \times \Delta_{}\rho_{22}(A))
))
\\
%
&\stackrel{(\ref{eq:b1})}{=}&
...
\\&&\quad
( A \times \rho_{2}(A) \times \rho_{11}(A) \times \pi_{id \rightarrow ID22, lane \rightarrow LANE22, time \rightarrow TIME22}\{\tuple{}\})\cup
\\&&\quad
%
(\pi_{id \rightarrow ID lane \rightarrow LANE, time \rightarrow TIME}\{\tuple{}\} \times \pi_{id \rightarrow ID2, lane \rightarrow LANE2, time \rightarrow TIME2}\{\tuple{}\} \times \rho_{11}(A) \times \rho_{22}(A))\cup
\\&&\quad
( \pi_{id \rightarrow ID, lane \rightarrow LANE, time \rightarrow TIME}\{\tuple{}\} \times \rho_{2}(A) \times \pi_{id \rightarrow ID11, lane \rightarrow LANE11, time \rightarrow TIME11}\{\tuple{}\} \times \rho_{22}(A))\cup
\\&&\quad
(\pi_{id \rightarrow ID, lane \rightarrow LANE, time \rightarrow TIME}\{\tuple{}\} \times \rho_{2}(A) \times \rho_{11}(A) \times \pi_{id \rightarrow ID22, lane \rightarrow LANE22, time \rightarrow TIME22}\{\tuple{}\})\cup
\\&&\quad
( A \times \pi_{id \rightarrow ID2, lane \rightarrow LANE2, time \rightarrow TIME2}\{\tuple{}\} \times \pi_{id \rightarrow ID11, lane \rightarrow LANE11, time \rightarrow TIME11}\{\tuple{}\} \times \rho_{22}(A))\cup
\\&&\quad
( A \times \pi_{id \rightarrow ID2, lane \rightarrow LANE2, time \rightarrow TIME2}\{\tuple{}\} \times \rho_{11}(A) \times \pi_{id \rightarrow ID22, lane \rightarrow LANE22, time \rightarrow TIME22}\{\tuple{}\})\cup
\\&&\quad
( A \times \rho_{2}(A) \times \pi_{id \rightarrow ID11, lane \rightarrow LANE11, time \rightarrow TIME11}\{\tuple{}\} \times \pi_{id \rightarrow ID22, lane \rightarrow LANE22, time \rightarrow TIME22}\{\tuple{}\})\cup
\\&&\quad
%
( \pi_{id , lane , time }\{\tuple{}\} \times \pi_{id, lane, time }\{\tuple{}\} \times \pi_{id, lane, time }\{\tuple{}\} \times \rho_{22}(A))\cup
\\&&\quad
( \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\} \times \rho_{11}(A) \times \pi_{id, lane, time}\{\tuple{}\})\cup
\\&&\quad
( \pi_{id, lane, time}\{\tuple{}\} \times \rho_{2}(A) \times \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\})\cup
\\&&\quad
( A \times \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\})\cup
\\&&\quad
( \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\})
))
\\
%
&=&
...
\\&&\quad
\sigma_{\dots}( A \times \rho_{2}(A) \times \rho_{11}(A) \times \pi_{id \rightarrow ID22, lane \rightarrow LANE22, time \rightarrow TIME22}\{\tuple{}\})\cup
\\&&\quad
\end{eqnarray*}
\pagebreak
\begin{eqnarray*}
&&\quad
\sigma_{\dots}(\pi_{id \rightarrow ID lane \rightarrow LANE, time \rightarrow TIME}\{\tuple{}\} \times \pi_{id \rightarrow ID2, lane \rightarrow LANE2, time \rightarrow TIME2}\{\tuple{}\} \times \rho_{11}(A) \times \rho_{22}(A))\cup
\\&&\quad
\sigma_{\dots}( \pi_{id \rightarrow ID, lane \rightarrow LANE, time \rightarrow TIME}\{\tuple{}\} \times \rho_{2}(A) \times \pi_{id \rightarrow ID11, lane \rightarrow LANE11, time \rightarrow TIME11}\{\tuple{}\} \times \rho_{22}(A))\cup
\\&&\quad
\sigma_{\dots}(\pi_{id \rightarrow ID, lane \rightarrow LANE, time \rightarrow TIME}\{\tuple{}\} \times \rho_{2}(A) \times \rho_{11}(A) \times \pi_{id \rightarrow ID22, lane \rightarrow LANE22, time \rightarrow TIME22}\{\tuple{}\})\cup
\\&&\quad
\sigma_{\dots}( A \times \pi_{id \rightarrow ID2, lane \rightarrow LANE2, time \rightarrow TIME2}\{\tuple{}\} \times \pi_{id \rightarrow ID11, lane \rightarrow LANE11, time \rightarrow TIME11}\{\tuple{}\} \times \rho_{22}(A))\cup
\\&&\quad
\sigma_{\dots}( A \times \pi_{id \rightarrow ID2, lane \rightarrow LANE2, time \rightarrow TIME2}\{\tuple{}\} \times \rho_{11}(A) \times \pi_{id \rightarrow ID22, lane \rightarrow LANE22, time \rightarrow TIME22}\{\tuple{}\})\cup
\\&&\quad
\sigma_{\dots}( A \times \rho_{2}(A) \times \pi_{id \rightarrow ID11, lane \rightarrow LANE11, time \rightarrow TIME11}\{\tuple{}\} \times \pi_{id \rightarrow ID22, lane \rightarrow LANE22, time \rightarrow TIME22}\{\tuple{}\})\cup
\\&&\quad
%
\sigma_{\dots}( \pi_{id , lane , time }\{\tuple{}\} \times \pi_{id, lane, time }\{\tuple{}\} \times \pi_{id, lane, time }\{\tuple{}\} \times \rho_{22}(A))\cup
\\&&\quad
\sigma_{\dots}( \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\} \times \rho_{11}(A) \times \pi_{id, lane, time}\{\tuple{}\})\cup
\\&&\quad
\sigma_{\dots}( \pi_{id, lane, time}\{\tuple{}\} \times \rho_{2}(A) \times \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\})\cup
\\&&\quad
\sigma_{\dots}( A \times \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\})\cup
\\&&\quad
\sigma_{\dots}( \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\} \times \pi_{id, lane, time}\{\tuple{}\})
)
\\
%
&\stackrel{(\ref{eq:rs1})}{=}&
