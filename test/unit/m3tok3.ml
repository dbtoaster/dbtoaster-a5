...
let init_code = 
	...
	Interpreter.compile_k3_expr (K.Block([
	  ...
	  K.PCValueUpdate(pc_r, [], to_kconsts [1.; 1.;], to_kconst 1.);
		...
		K.PCValueUpdate(pc_r_str, [], [K.Const(C.CString("aha")); K.Const(C.CString("ahaa"));], to_kconst 1.);
...
in
      ...
      (**)
		...
		test_expr " AFn " 
							...
							"{ [ / : FLOAT ] ( A : INT, B ) }" (VK.BaseValue(C.CFloat(1.5)));
		test_expr " AFn " 
							~env:["A", (C.CInt(2));"B", (C.CInt(2))]
							"{ [ / : INT ] ( A : INT, B : INT ) }" (VK.BaseValue(C.CInt(1)));
		...
		test_expr_coll " External - PC - Collection Slice " 
							~env:["A", (C.CFloat(1.));"B", (C.CFloat(1.));"C", (C.CFloat(1.))]
							"W[A,B][C,D]" 
							[  [2.], 2.;
				         [1.], 1.;
				      ];
		...
		test_expr " External - InPC - Singleton Init " 
							~env:["A", (C.CFloat(2.));"B", (C.CFloat(3.));"D", (C.CFloat(1.))]
							~generate_init:true
							"T[A,B][]( R[][A,D] * 3 )" (VK.BaseValue(C.CFloat(6.)));
		test_expr " External - PC - Singleton Init " 
							~env:["A", (C.CFloat(2.));"B", (C.CFloat(3.));"C", (C.CFloat(1.));"D", (C.CFloat(3.))]
							~generate_init:true
							"W[A,B][C,D]( R[][C,D] * 3 )" (VK.BaseValue(C.CFloat(9.)));
		...
		test_expr_coll " External - PC - Slice Init " 
							~env:["A", (C.CFloat(2.));"B", (C.CFloat(3.));"C", (C.CFloat(2.))]
							~generate_init:true
							"W[A,B][C,D]( R[][C,D] * 3 )" 
							[  [2.], 12.;
				         [1.], 6.;
		...
		test_expr " AggSum Singleton from Singleton "
							"AggSum([], {5.})" (VK.BaseValue(C.CFloat(5.)));
		test_expr " AggSum Singleton from Collection "
							"AggSum([], R[][A,B] * {A = B})" (VK.BaseValue(C.CFloat(5.)));
		...
		test_expr_coll2 " Lift Singleton "
							~env:["A", (C.CFloat(2.));"B", (C.CFloat(2.));]
							"( L ^= ( R[][A,B] ) )"
							[ [(VK.BaseValue(C.CFloat(4.)))], (VK.BaseValue(C.CInt(1)))];
		test_expr_coll2 " Lift Collection "
							~env:["A", (C.CFloat(2.));]
							"( L ^= ( R[][A,B] ) )"
							[ [(VK.BaseValue(C.CFloat(2.)));(VK.BaseValue(C.CFloat(4.)))], (VK.BaseValue(C.CInt(1)));
								[(VK.BaseValue(C.CFloat(1.)));(VK.BaseValue(C.CFloat(2.)))], (VK.BaseValue(C.CInt(1)));
							];
							
		test_expr " Sum Singleton "
							~env:["A", (C.CFloat(1.));"B", (C.CFloat(3.));
										"C", (C.CFloat(2.));"D", (C.CFloat(2.));
										"E", (C.CFloat(2.));"F", (C.CFloat(2.));]
							" R[][A,B] + W[C,D][E,F] " (VK.BaseValue(C.CFloat(7.)));
		test_expr_coll " Sum Collection "
							~env:["A", (C.CFloat(1.));
										"C", (C.CFloat(3.));"D", (C.CFloat(2.));
										"E", (C.CFloat(2.));]
		...
		test_expr " Prod Singleton "
							~env:["A", (C.CFloat(1.));"B", (C.CFloat(3.));
										"C", (C.CFloat(2.));"D", (C.CFloat(2.));
										"E", (C.CFloat(2.));"F", (C.CFloat(2.));]
							" R[][A,B] * W[C,D][E,F] " (VK.BaseValue(C.CFloat(12.)));
