...
#generate_agendas $AGENDAS_INPUT_DIR $AGENDAS_OUTPUT_DIR "$FINANCIAL_DATASETS" "$FINANCIAL_QUERIES"
...
#generate_agendas $AGENDAS_INPUT_DIR $AGENDAS_OUTPUT_DIR "$MDDB_DATASETS" "$MDDB_QUERIES"
