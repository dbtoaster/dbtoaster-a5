...
CREATE STREAM S(B int, C int) 
  FROM FILE '../dbtoaster-experiments-data/simple/standard/s.dat' LINE DELIMITED csv;

CREATE STREAM T(C int, D int)
  FROM FILE '../dbtoaster-experiments-data/simple/standard/t.dat' LINE DELIMITED csv;
