...
CREATE STREAM R(A int, B int) 
  FROM FILE '../../experiments/data/simple/normal/r.dat' LINE DELIMITED csv;

CREATE STREAM S(B int, C int) 
  FROM FILE '../../experiments/data/simple/normal/s.dat' LINE DELIMITED csv;

CREATE STREAM T(C int, D int)
  FROM FILE '../../experiments/data/simple/normal/t.dat' LINE DELIMITED csv;
