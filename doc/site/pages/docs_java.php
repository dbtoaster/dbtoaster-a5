...
class ExampleApp {
   ...
   public static void main(String[] args) {
      ...
      // Send events
      Tuple2 result;
      System.out.println("Insert a tuple to R.");
      q.tell(new TupleEvent(0, TUPLE_INSERT, "R", tuple(5L, 2L)), null);

      System.out.println("Insert a tuple to S.");
      q.tell(new TupleEvent(1, TUPLE_INSERT, "S", tuple(2L, 3L)), null);

      System.out.println("Insert a tuple to T.");
      ...
      System.out.println("Insert another tuple to T.");
