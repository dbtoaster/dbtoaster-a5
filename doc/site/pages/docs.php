...
<p>
   After the compilation, copy the <tt>.a</tt> files to <tt>lib/dbt_c++</tt> and the <tt>.dylib</tt> to the directory where you are storing the C++ binaries generated by DBToaster.
