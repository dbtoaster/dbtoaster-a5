<p>DBToaster generates lightweight, specialized, embeddable query engines for applications that require real-time, low-latency data processing and monitoring capabilities. </p>
...
<p>The DBToaster compiler accepts queries written in SQL, and generates query engine code that can be incorporated directly into any C++, Java, or Scala project.
</p>
