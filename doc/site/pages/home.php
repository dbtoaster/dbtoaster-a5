...
<div class="container">
  <section class="btn-wrapper-download">
    <div class="download-btns">
      <span class="download-text"><i class="fa fa-cloud-download">&nbsp;&nbsp;</i>Download DBToaster 2</span>
      <div class="linux-btn-wrapper" style="display: none;">
        <div class="linux-bit" style="display: none;"> <!-- -->
          <ul>
            <li><a href="dist/dbtoaster_rhel6.5_x86_64_3263.tgz">&nbsp;&nbsp;&nbsp;RHEL&nbsp;&nbsp;&nbsp;</a></li>
            <li><a href="dist/dbtoaster_ubuntu12.04_x86_64_3263.tgz">&nbsp;Ubuntu&nbsp;</a></li>
          </ul>
        </div>
        <a href="dist/dbtoaster_ubuntu12.04_x86_64_3263.tgz" class="linux-btn" title="Choose your Linux System" ><i class="fa fa-linux"></i></a>
      </div>
      <a href="dist/dbtoaster_darwin_3263.tgz" class="mac-btn" title="Mac OS X Lion (10.6.8)" style="display: none;"><i class="fa fa-apple"></i></a>
      <a href="dist/dbtoaster_cygwin_3263.tgz" class="windows-btn" title="Windows (Cygwin)" style="display: none;"><i class="fa fa-windows"></i></a>
    </div>
