...
BULK INSERT orders FROM '/home/yanif/datasets/tpch/sf1/singlefile/orders.tbl.a'
WITH ( FIELDTERMINATOR='|', ROWTERMINATOR='\n', FIRE_TRIGGERS );

BULK INSERT lineitem FROM '/home/yanif/datasets/tpch/sf1/singlefile/lineitem.tbl.a'
WITH ( FIELDTERMINATOR='|', ROWTERMINATOR='\n', FIRE_TRIGGERS );
*/