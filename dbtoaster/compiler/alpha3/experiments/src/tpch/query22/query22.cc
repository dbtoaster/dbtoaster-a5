...
{
   cout << "bigsum_C1__CUSTKEY_dom size: " << (((sizeof(set<int64_t>::value_type)
   ...
   cout << "qCUSTOMER2 size: " << (((sizeof(map<int64_t,int>::key_type)
       + sizeof(map<int64_t,int>::mapped_type)
       + sizeof(struct _Rb_tree_node_base))
       * qCUSTOMER2.size())  + (sizeof(struct _Rb_tree<map<int64_t,int>::key_type, map<int64_t,int>::value_type, _Select1st<map<int64_t,int>::value_type>, map<int64_t,int>::key_compare>))) << endl;

   (*stats) << "m," << "qCUSTOMER2" << "," << (((sizeof(map<int64_t,int>::key_type)
       + sizeof(map<int64_t,int>::mapped_type)
       + sizeof(struct _Rb_tree_node_base))
       * qCUSTOMER2.size())  + (sizeof(struct _Rb_tree<map<int64_t,int>::key_type, map<int64_t,int>::value_type, _Select1st<map<int64_t,int>::value_type>, map<int64_t,int>::key_compare>))) << endl;

   cout << "bigsum_C1__ACCTBAL_dom size: " << (((sizeof(set<double>::value_type)
       + sizeof(struct _Rb_tree_node_base))
       * bigsum_C1__ACCTBAL_dom.size())  + (sizeof(struct _Rb_tree<set<double>::key_type, set<double>::value_type, _Identity<set<double>::value_type>, set<double>::key_compare>))) << endl;

   (*stats) << "m," << "bigsum_C1__ACCTBAL_dom" << "," << (((sizeof(set<double>::value_type)
       + sizeof(struct _Rb_tree_node_base))
       * bigsum_C1__ACCTBAL_dom.size())  + (sizeof(struct _Rb_tree<set<double>::key_type, set<double>::value_type, _Identity<set<double>::value_type>, set<double>::key_compare>))) << endl;

   cout << "qCUSTOMER3 size: " << (((sizeof(map<tuple<double,int64_t,int64_t>,double>::key_type)
       + sizeof(map<tuple<double,int64_t,int64_t>,double>::mapped_type)
       + sizeof(struct _Rb_tree_node_base))
       * qCUSTOMER3.size())  + (sizeof(struct _Rb_tree<map<tuple<double,int64_t,int64_t>,double>::key_type, map<tuple<double,int64_t,int64_t>,double>::value_type, _Select1st<map<tuple<double,int64_t,int64_t>,double>::value_type>, map<tuple<double,int64_t,int64_t>,double>::key_compare>))) << endl;

   (*stats) << "m," << "qCUSTOMER3" << "," << (((sizeof(map<tuple<double,int64_t,int64_t>,double>::key_type)
       + sizeof(map<tuple<double,int64_t,int64_t>,double>::mapped_type)
       + sizeof(struct _Rb_tree_node_base))
       * qCUSTOMER3.size())  + (sizeof(struct _Rb_tree<map<tuple<double,int64_t,int64_t>,double>::key_type, map<tuple<double,int64_t,int64_t>,double>::value_type, _Select1st<map<tuple<double,int64_t,int64_t>,double>::value_type>, map<tuple<double,int64_t,int64_t>,double>::key_compare>))) << endl;
    ...
    MKTSEGMENT,string COMMENT)
{
    ...
    set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it6 = bigsum_C1__CUSTKEY_dom.find(CUSTKEY);
    set<double>::iterator bigsum_C1__ACCTBAL_dom_it4 = bigsum_C1__ACCTBAL_dom.find(ACCTBAL);
    ...
    for (; q_it12 != q_end11; ++q_it12)
    {
        ...
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it10 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end9 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it10)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it8 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end7 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it18 = q.begin();
    map<int64_t,double>::iterator q_end17 = q.end();
    for (; q_it18 != q_end17; ++q_it18)
    {
        int64_t NATIONKEY = q_it18->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it16 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end15 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it16)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it14 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end13 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it24 = q.begin();
    map<int64_t,double>::iterator q_end23 = q.end();
    for (; q_it24 != q_end23; ++q_it24)
    {
        int64_t NATIONKEY = q_it24->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it22 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end21 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it22)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it20 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end19 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it30 = q.begin();
    map<int64_t,double>::iterator q_end29 = q.end();
    for (; q_it30 != q_end29; ++q_it30)
    {
        int64_t NATIONKEY = q_it30->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it28 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end27 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it28)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it26 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end25 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<tuple<double,int64_t,int64_t>,double>::iterator qCUSTOMER3_it34 = qCUSTOMER3.find(make_tuple(ACCTBAL,CUSTKEY,NATIONKEY));
    ...
    ORDERPRIORITY,string CLERK,int SHIPPRIORITY,string COMMENT)
{
    ...
    for (; q_it40 != q_end39; ++q_it40)
    {
        ...
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it38 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end37 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it38)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it36 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end35 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it46 = q.begin();
    map<int64_t,double>::iterator q_end45 = q.end();
    for (; q_it46 != q_end45; ++q_it46)
    {
        int64_t C1__NATIONKEY = q_it46->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it44 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end43 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it44)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it42 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end41 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it52 = q.begin();
    map<int64_t,double>::iterator q_end51 = q.end();
    for (; q_it52 != q_end51; ++q_it52)
    {
        int64_t C1__NATIONKEY = q_it52->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it50 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end49 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it50)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it48 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end47 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it58 = q.begin();
    map<int64_t,double>::iterator q_end57 = q.end();
    for (; q_it58 != q_end57; ++q_it58)
    {
        int64_t C1__NATIONKEY = q_it58->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it56 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end55 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it56)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it54 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end53 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    MKTSEGMENT,string COMMENT)
{
    ...
    map<int64_t,double>::iterator q_it70 = q.begin();
    map<int64_t,double>::iterator q_end69 = q.end();
    for (; q_it70 != q_end69; ++q_it70)
    {
        int64_t NATIONKEY = q_it70->first;

        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it68 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end67 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it68)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it66 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end65 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it76 = q.begin();
    map<int64_t,double>::iterator q_end75 = q.end();
    for (; q_it76 != q_end75; ++q_it76)
    {
        int64_t NATIONKEY = q_it76->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it74 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end73 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it74)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it72 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end71 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it82 = q.begin();
    map<int64_t,double>::iterator q_end81 = q.end();
    for (; q_it82 != q_end81; ++q_it82)
    {
        int64_t NATIONKEY = q_it82->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it80 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end79 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it80)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it78 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end77 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it88 = q.begin();
    map<int64_t,double>::iterator q_end87 = q.end();
    for (; q_it88 != q_end87; ++q_it88)
    {
        int64_t NATIONKEY = q_it88->first;

        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it86 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end85 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it86)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it84 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end83 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<tuple<double,int64_t,int64_t>,double>::iterator qCUSTOMER3_it92 = qCUSTOMER3.find(make_tuple(ACCTBAL,CUSTKEY,NATIONKEY));
    ...
    ORDERPRIORITY,string CLERK,int SHIPPRIORITY,string COMMENT)
{
    ...
    for (; q_it98 != q_end97; ++q_it98)
    {
        ...
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it96 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end95 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it96)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it94 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end93 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it104 = q.begin();
    map<int64_t,double>::iterator q_end103 = q.end();
    for (; q_it104 != q_end103; ++q_it104)
    {
        int64_t C1__NATIONKEY = q_it104->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it102 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end101 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it102)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it100 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end99 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it110 = q.begin();
    map<int64_t,double>::iterator q_end109 = q.end();
    for (; q_it110 != q_end109; ++q_it110)
    {
        int64_t C1__NATIONKEY = q_it110->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it108 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end107 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it108)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it106 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end105 = bigsum_C1__ACCTBAL_dom.end();
            for (
    ...
    map<int64_t,double>::iterator q_it116 = q.begin();
    map<int64_t,double>::iterator q_end115 = q.end();
    for (; q_it116 != q_end115; ++q_it116)
    {
        int64_t C1__NATIONKEY = q_it116->first;
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_it114 = bigsum_C1__CUSTKEY_dom.begin();
        set<int64_t>::iterator bigsum_C1__CUSTKEY_dom_end113 = bigsum_C1__CUSTKEY_dom.end();
        for (
            ...
            ++bigsum_C1__CUSTKEY_dom_it114)
        {
            ...
            set<double>::iterator bigsum_C1__ACCTBAL_dom_it112 = bigsum_C1__ACCTBAL_dom.begin();
            set<double>::iterator bigsum_C1__ACCTBAL_dom_end111 = bigsum_C1__ACCTBAL_dom.end();
            for (
