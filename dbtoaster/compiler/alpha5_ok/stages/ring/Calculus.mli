...
val mk_aggsum: var_t list -> 'i calc_t -> 'i calc_t
...
val get_bound_schema : 'a calc_t -> var_t list
val get_unbound_schema : 'a calc_t -> var_t list
...
(* Returns true if (A * B) can be rewritten as (B * A) 
   ...
   in the expression. *)
val commutes_with : ?ivars:var_t list -> 'a calc_t -> 'b calc_t -> bool
