...
if [ ! -d $esper_dir -o ! -f $esper_dir/src/org/dbtoaster/experiments/clustermgmt/ClusterMgmtSkeleton.java ]; then
...
if [ ! -d $bin_dir -o ! -f $bin_dir/org/dbtoaster/experiments/clustermgmt/ClusterMgmtSkeleton.class ]; then
