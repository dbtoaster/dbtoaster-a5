...
--
--CREATE TEMPORARY TABLE part_totals AS
--  SELECT 
--    expectation_sum(sales, increase_per_part, 1000) AS sales,
--    part
--  FROM
--    increase_per_part
--  GROUP BY
...
CREATE TEMPORARY TABLE increase_per_part AS
  SELECT
    expectation_sum((increase + 1) * "L_QUANTITY" * popularity, partpopularity, 1000) AS sales,
    "L_PARTKEY" AS part
  FROM
    "LINEITEM","ORDERS",
    (SELECT
