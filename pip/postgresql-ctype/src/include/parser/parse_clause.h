...
/*** BEGIN PIP ***/
extern bool varIsCType(Oid typid);
extern Node *transformCTypedBoolExpr(ParseState *pstate, Node *whereClause, 
            List **conditions, const char *constructName);
extern List *transformTargetListKeepingCTypes(ParseState *pstate, List *targetlist);
/*** END PIP ***/
