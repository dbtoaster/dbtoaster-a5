...
\noindent Throughout this document we use the implicit loop form. \todo{Talk
about above statement as an example of marginalization over the entire stream.}
...
the given value of the trigger argument {\tt ok}. \todo{Talk about slices here.}
