...
\ref{sec:overview}, we further characterize the notion of a DDMS, discuss the
state machine abstraction, and describe schema and view definition formalisms.
...
minimization or compilation of the state transition function, leads to new
algorithms. Section \ref{sec:storage} discusses storage management in DBToaster.
Finally, Section \ref{sec:distribution} discusses scaling up through
parallelization.
