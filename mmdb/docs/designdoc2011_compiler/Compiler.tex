...
type memo_t = 
  ...
  * (   pm_t * string         (* Insert/Delete + Base Relation Name *)
      * invocation_t option   (* LHS initializer *)
      * invocation_t list     (* Update operations *)
    ) list

and invocation_t =
  * schema_t              (* Invocation schema mappings *)
