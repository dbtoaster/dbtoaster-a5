...
\item Portions of the expression may involve constants.  Applying the constant at read time does not increase time complexity, and makes it easier to share memos.  

\item Similarly, portions of the expression may involve parameters.  Depending on whether or not the parameters are treated as constants, we can perform filtering at read time or at write time.
\end{itemize}
