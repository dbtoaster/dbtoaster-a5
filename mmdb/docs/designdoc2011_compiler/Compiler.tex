...
Like If-lifting, performing a task every loop is inefficient.  The higher the expression can be lifted, the better.  \todo{I suspect however, that we're actually doing as well as we can do.}
