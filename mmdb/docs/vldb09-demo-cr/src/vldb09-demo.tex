...
orderbook data for algos, our approach stands alone in its ability to support
...
orderbook trading and moving object applications are self-managing, in that the
...
and the performance advantages of compiled query processors through live
comparisons with alternative database implementations. In this section we
describe the application scenarios that act as motivating use cases for
\compiler, as well as the visualization tools that convey the technical aspects
of query transformations and compiled executor performance.
