...
includes a parameter {\tt @ck}, that is to be filled in by the values present in
...
aggregates for every $ordkey$, $sprior$ seen in the update stream, as does
$m'$. We iterate over every entry in $m$, to maintain $m$ from $m'$, leading to
