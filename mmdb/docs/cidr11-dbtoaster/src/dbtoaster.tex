...
$ordkey$,$sprior$ are not arguments, indicating a loop. Furthermore, the order
of entries updated does not matter, enabling embarrassing update
parallelization, as we discuss in Section~\ref{sec:distribution}.
