...
date, and so forth (cf. e.g. \cite{olston-cidr:09,bast-cidr:07}).
...
A DDMS is a lightweight system, not necessarily providing additional DBMS
...
large-scale analytics applications. Continually fresh DDMS views at first seem
at odds with the bulk update processing dogma of DBMS, but enable important
...
the number of programmers frequently exceeds the number of strategy designers by
...
and aggregation. In general, we expect DDMS st support standard SQL.
