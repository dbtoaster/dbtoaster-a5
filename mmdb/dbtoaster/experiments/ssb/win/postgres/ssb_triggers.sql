...
copy region (regionkey, name, comment) from E'C:\Temp\ssb\data\region.tbl' with delimiter '|';

copy nation (nationkey, name, regionkey, comment) from E'C:\Temp\ssb\data\nation.tbl' with delimiter '|';

copy part from E'C:\Temp\ssb\data\part.tbl.a' with delimiter '|';
copy customer from E'C:\Temp\ssb\data\customer.tbl.a' with delimiter '|';
copy supplier from E'C:\Temp\ssb\data\supplier.tbl.a' with delimiter '|';
