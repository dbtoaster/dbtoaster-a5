 ...
 */
#ifndef query20_TYPES_H
#define query20_TYPES_H
...
class asks_elem {
 public:
  ...
  asks_elem() : t11(0), id11(0), broker_id11(0), p11(0), v11(0) {
  }

  virtual ~asks_elem() throw() {}
  ...
  bool operator == (const asks_elem & rhs) const
  {
    if (!(t11 == rhs.t11))
      return false;
    if (!(id11 == rhs.id11))
  ...
  bool operator < (const asks_elem & ) const;
