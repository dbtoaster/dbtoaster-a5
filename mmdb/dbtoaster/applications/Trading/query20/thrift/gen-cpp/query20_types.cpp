...
const char* asks_elem::ascii_fingerprint = "2EB010665070FC89CB24AB9DA34D5F9D";
const uint8_t asks_elem::binary_fingerprint[16] = {0x2E,0xB0,0x10,0x66,0x50,0x70,0xFC,0x89,0xCB,0x24,0xAB,0x9D,0xA3,0x4D,0x5F,0x9D};

uint32_t asks_elem::read(apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t asks_elem::write(apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("asks_elem");
