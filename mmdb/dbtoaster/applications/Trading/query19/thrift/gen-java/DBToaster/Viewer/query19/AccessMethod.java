...
public class AccessMethod {
  ...
  public interface Iface extends DBToaster.Profiler.Protocol.Profiler.Iface {
    ...
    public List<bids_elem> get_bids() throws TException;
  ...
  public static class Client extends DBToaster.Profiler.Protocol.Profiler.Client implements Iface {
    ...
    {
      send_get_bids();
      return recv_get_bids();
    }

    public void send_get_bids() throws TException
    {
      oprot_.writeMessageBegin(new TMessage("get_bids", TMessageType.CALL, seqid_));
      get_bids_args args = new get_bids_args();
      args.write(oprot_);
      oprot_.writeMessageEnd();
      oprot_.getTransport().flush();
    }

    public List<bids_elem> recv_get_bids() throws TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      get_bids_result result = new get_bids_result();
      result.read(iprot_);
      iprot_.readMessageEnd();
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new TApplicationException(TApplicationException.MISSING_RESULT, "get_bids failed: unknown result");
    }
  ...
  public static class Processor extends DBToaster.Profiler.Protocol.Profiler.Processor implements TProcessor {
    ...
    public Processor(Iface iface)
    {
      ...
      processMap_.put("get_bids", new get_bids());
    ...
    private class get_bids implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        get_bids_args args = new get_bids_args();
        args.read(iprot);
        iprot.readMessageEnd();
        get_bids_result result = new get_bids_result();
        result.success = iface_.get_bids();
        oprot.writeMessageBegin(new TMessage("get_bids", TMessageType.REPLY, seqid));
        result.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
      }
  ...
  public static class get_bids_args implements TBase, java.io.Serializable, Cloneable, Comparable<get_bids_args>   {
    private static final TStruct STRUCT_DESC = new TStruct("get_bids_args");

    public static final Map<Integer, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new HashMap<Integer, FieldMetaData>() {{
    }});

    static {
      FieldMetaData.addStructMetaDataMap(get_bids_args.class, metaDataMap);
    }

    public get_bids_args() {
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public get_bids_args(get_bids_args other) {
    }

    @Override
    public get_bids_args clone() {
      return new get_bids_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof get_bids_args)
        return this.equals((get_bids_args)that);
      return false;
    }

    public boolean equals(get_bids_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(get_bids_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      get_bids_args typedOther = (get_bids_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("get_bids_args(");
      boolean first = true;
  ...
  public static class get_bids_result implements TBase, java.io.Serializable, Cloneable, Comparable<get_bids_result>   {
    private static final TStruct STRUCT_DESC = new TStruct("get_bids_result");
    private static final TField SUCCESS_FIELD_DESC = new TField("success", TType.LIST, (short)0);

    public List<bids_elem> success;
    public static final int SUCCESS = 0;
    ...
    public static final Map<Integer, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new HashMap<Integer, FieldMetaData>() {{
      put(SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT, 
          new ListMetaData(TType.LIST, 
              new StructMetaData(TType.STRUCT, bids_elem.class))));
    }});

    static {
      FieldMetaData.addStructMetaDataMap(get_bids_result.class, metaDataMap);
    }

    public get_bids_result() {
    }

    public get_bids_result(
      List<bids_elem> success)
    {
      this();
      this.success = success;
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public get_bids_result(get_bids_result other) {
      if (other.isSetSuccess()) {
        List<bids_elem> __this__success = new ArrayList<bids_elem>();
        for (bids_elem other_element : other.success) {
          __this__success.add(new bids_elem(other_element));
        }
        this.success = __this__success;
      }
    }
    ...
    @Override
    public get_bids_result clone() {
      return new get_bids_result(this);
    }

    public List<bids_elem> getSuccess() {
      return this.success;
    }

    public get_bids_result setSuccess(List<bids_elem> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(int fieldID, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<bids_elem>)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof get_bids_result)
        return this.equals((get_bids_result)that);
      return false;
    }

    public boolean equals(get_bids_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(get_bids_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      get_bids_result typedOther = (get_bids_result)other;
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new ArrayList<bids_elem>(_list10.size);
                for (int _i11 = 0; _i11 < _list10.size; ++_i11)
                {
                  bids_elem _elem12;
                  _elem12 = new bids_elem();
                  _elem12.read(iprot);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (bids_elem _iter13 : this.success)          {
            _iter13.write(oprot);
          }
          oprot.writeListEnd();
        }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("get_bids_result(");
      boolean first = true;
