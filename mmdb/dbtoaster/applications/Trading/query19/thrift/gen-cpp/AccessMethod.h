 ...
 */
#ifndef AccessMethod_H1
#define AccessMethod_H1
...
class AccessMethodIf : virtual public DBToaster::Profiler::Protocol::ProfilerIf {
 public:
  ...
  virtual void get_bids(std::vector<bids_elem> & _return) = 0;
...
class AccessMethodNull : virtual public AccessMethodIf , virtual public DBToaster::Profiler::Protocol::ProfilerNull {
 public:
  ...
  void get_bids(std::vector<bids_elem> & /* _return */) {
    return;
  }
...
class AccessMethod_get_bids_args {
 public:

  AccessMethod_get_bids_args() {
  }

  virtual ~AccessMethod_get_bids_args() throw() {}


  bool operator == (const AccessMethod_get_bids_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const AccessMethod_get_bids_args &rhs) const {
  ...
  bool operator < (const AccessMethod_get_bids_args & ) const;
...
class AccessMethod_get_bids_pargs {
 public:


  virtual ~AccessMethod_get_bids_pargs() throw() {}
...
class AccessMethod_get_bids_result {
 public:

  AccessMethod_get_bids_result() {
  }

  virtual ~AccessMethod_get_bids_result() throw() {}

  std::vector<bids_elem>  success;
  ...
  bool operator == (const AccessMethod_get_bids_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const AccessMethod_get_bids_result & ) const;
...
class AccessMethod_get_bids_presult {
 public:


  virtual ~AccessMethod_get_bids_presult() throw() {}
...
class AccessMethodClient : virtual public AccessMethodIf, public DBToaster::Profiler::Protocol::ProfilerClient {
 public:
  ...
  void get_bids(std::vector<bids_elem> & _return);
  void send_get_bids();
  void recv_get_bids(std::vector<bids_elem> & _return);
  void get_map1(std::map<int32_t, int32_t> & _return);
  void send_get_map1();
...
class AccessMethodProcessor : virtual public apache::thrift::TProcessor, public DBToaster::Profiler::Protocol::ProfilerProcessor {
 ...
 private:
  ...
  void process_get_bids(int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
 ...
 public:
  AccessMethodProcessor(boost::shared_ptr<AccessMethodIf> iface) :
    ...
    processMap_["get_bids"] = &AccessMethodProcessor::process_get_bids;
