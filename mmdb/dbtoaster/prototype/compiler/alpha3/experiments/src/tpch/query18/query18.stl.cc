    ...
    EXTENDEDPRICE,double DISCOUNT,double TAX)
{
    ...
    {
        multiset<tuple<int64_t,int64_t,int64_t,int,double,double,double,double> >::iterator LINEITEM_it2 = LINEITEM.begin();
        multiset<tuple<int64_t,int64_t,int64_t,int,double,double,double,double> >::iterator LINEITEM_end1 = LINEITEM.end();
    ...
    {
        multiset<tuple<int64_t,int64_t,int64_t,int,double,double,double,double> >::iterator LINEITEM_it4 = LINEITEM.begin();
        multiset<tuple<int64_t,int64_t,int64_t,int,double,double,double,double> >::iterator LINEITEM_end3 = LINEITEM.end();
    ...
    */
    ...
    for (; q_it254 != q_end253; ++q_it254)
    {
            ...
            ++bigsum_L1__ORDERKEY_dom_it252)
        {
            ...
            set<int64_t>::iterator bigsum_L2__ORDERKEY_dom_it236 = bigsum_L2__ORDERKEY_dom.find(ORDERKEY);
            ...
            set<int64_t>::iterator bigsum_L2__ORDERKEY_dom_it240 = bigsum_L2__ORDERKEY_dom.find(ORDERKEY);
            ...
            set<int64_t>::iterator bigsum_L2__ORDERKEY_dom_it244 = bigsum_L2__ORDERKEY_dom.find(ORDERKEY);
