...
namespace DBToaster
{
    namespace StandaloneEngine
    {
        ...
        // Note: adaptors can indicate a tuple should be dropped, i.e. never passed to
        // any DBToaster handler function.
        enum DmlType { insertTuple, deleteTuple, dropTuple };
