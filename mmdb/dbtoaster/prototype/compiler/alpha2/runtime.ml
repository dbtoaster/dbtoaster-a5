...
(* main() { declare multiplexer, dispatcher; loop over multiplexer, dispatching; start thrift viewer service }  *)
...
(* declare multiplexer; main() { start read loop; run io_service in a thread, start thrift viewer service }  *)
