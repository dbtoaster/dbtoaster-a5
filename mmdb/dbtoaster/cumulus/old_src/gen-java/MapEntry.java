...
public class MapEntry implements TBase<MapEntry._Fields>, java.io.Serializable, Cloneable, Comparable<MapEntry> {
  private static final TStruct STRUCT_DESC = new TStruct("MapEntry");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(MapEntry.class, metaDataMap);
  }
  ...
  public MapEntry setSource(long source) {
    this.source = source;
    setSourceIsSet(true);
    return this;
  }
  ...
  public MapEntry setKey(List<Long> key) {
    this.key = key;
    return this;
  }
  ...
  public int compareTo(MapEntry other) {
    ...
    MapEntry typedOther = (MapEntry)other;
